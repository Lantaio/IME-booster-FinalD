...
<+LWin:: MsgBox "　　　　　　　for Rime " Version "`n© 2024 Brought to you by Uncle Joy with his 💔 out.", "About FinalD IME plugin", "Iconi T6"  ; LShift键作为前缀键时，可使得LShift键单独作为热键时只在弹起，并且没有同时按其它键时触发。
>+LWin:: MsgBox "　　　　Rime定制版 " Version "`n© 2024 由曾伯伯为你呕💔沥血打磨呈献。", "关于 终点 输入法插件", "Iconi T6"  ; RShift键作为前缀键时，可使得RShift键单独作为热键时只在弹起，并且没有同时按其它键时触发。
