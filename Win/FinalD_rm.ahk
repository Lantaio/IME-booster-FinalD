...
<#0:: {  ; 左Win+0 显示此程序的版本信息以及各项功能的状态信息。
	msg := "　　　　　 终点输入法插件 Rime定制版 v5.50.114`n　　　　　© 2024 由曾伯伯为你呕💔沥血打磨呈献。`n　　　https://github.com/Lantaio/IME-booster-FinalD`n　　　　　　　　　快捷键及各项功能的状态：`n左Win+c 运行/停止 此插件"
	if A_IsSuspended
