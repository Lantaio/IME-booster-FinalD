...
global Version := "v1.35.70"  ; 程序版本号信息
; 借助剪砧板获取光镖前一个子符
getQ1ZiFv() {
...
>+LWin::
<+LWin:: MsgBox "　　　　　　Rime定制版 " Version "`n　　© 2024 由曾伯伯为你呕💔沥血打磨呈献。`nhttps://github.com/Lantaio/IME-booster-FinalD", "关于 终点 输入法插件", "Iconi"  ; LShift键作为前缀键时，可使得Shift键单独作为热键时只在弹起，并且没有按过其它键时触发。
