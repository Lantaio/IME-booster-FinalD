...
### 新增功能
* 🎊破除形式主义，不忘“智能化地提高输入速度”这个初心，重新设计和优化此插件的功能（2024/6/7~11）
...
### 缺陷修复
* 通过将左<kbd>Shift</kbd>功能键改为右<kbd>Ctrl</kbd>键，留出左<kbd>Shift</kbd>键和左<kbd>Ctrl</kbd>键，以便不影响原有的各种功能，解决在文件管理器中用<kbd>Shift</kbd>键连续选择多个文件的问题（#7），解决用<kbd>Shift</kbd>键+鼠标滚轮来左右移动屏幕会触发替换光标前的标点符号的问题（#10）（2024/6/7）
* 修复个别临时标点没有修改的bug（2024/6/10）
* 修复各个须要排除的软件的正则表达式问题（2024/6/15）
