...
### 新增功能
* 🎊实现全键盘漂移。大小写英文字母可变换为对应的大小写希腊字母，数字可变换为上下标数字或数字序号（2024/8/10~13）

### 优化更改
* 🎊再次破除封建思想，完全以“**更少的按键、更人性化的设计、更方便快捷的方式输入标点符号**”为核心理念，重新设计此插件的功能（2024/6/18~8/9）
* 🛠️优化‘‘’和‘“’号的输入逻辑（2024/8/10~13）

### 缺陷修复
* 🛠️明确排除微软拼音的候选窗口，以防止可能存在的问题（2024/6/17）
* 🛠️修复仅按下Shift+Ctrl键的情况时，先释放Ctrl键再释放Shift键会触发变换光标前木示点的问题（2024/7/13）
