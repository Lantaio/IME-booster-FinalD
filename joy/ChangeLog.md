...
### 劈叉更改
* 🤸‍♂️将开/关此程序的快捷键修改为 左<kbd>Win</kbd>+<kbd>.</kbd>；将显示此程序的版本信息以及各项功能状态信息的快捷键修改为 左<kbd>Win</kbd>+<kbd>Alt</kbd>+<kbd>.</kbd>(2025/12/29)
* 🤸‍♀️将暂停/恢复执行此程序的快捷键修改为 <kbd>Shift</kbd>+<kbd>Pause</kbd>(2026/3/5)
* 🤸‍♂️调换 左Shift键 和 右Shift键 变换数字的方式，使变换逻辑更统一、更好记（2026/3/23）
...
* 🐣️增加`driftToENG`和`driftToGRC`函数进行代码复用，以便可通过不同方式进行全键盘漂移，并添加新的快捷键（2026/3/23）
* 🐣️数字后长按<kbd>.</kbd>、<kbd>,</kbd>和<kbd>:</kbd>键输入中文标点符号（2026/4/10）
* 🐣️增加字母箭头键功能（2026/4/12）
* 🐣️增加全局变量Interval以便调整连按间隔时间（2026/4/16）
...
* ✨优化smartType函数，使其可以在长按时在英文字母或数字后输出连续的英文标点（2026/4/18）
