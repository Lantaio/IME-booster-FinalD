...
* 🤸‍♂️将 左<kbd>Shift</kbd>+左<kbd>Win</kbd>快捷键更改为开/关字母箭头键功能。调换 左<kbd>Shift</kbd>键 和 右Shift键 变换数字的方式，使变换逻辑更统一、更好记（2026/3/23）
...
* 🐣️英文字母或数字后长按标点键输入中文标点符号（2026/4/10）
* 🐣️增加字母箭头键功能，长按<kbd>i</kbd>、<kbd>k</kbd>、<kbd>j</kbd>和<kbd>l</kbd>键分别输入<kbd>↑</kbd>
、<kbd>↓</kbd>、<kbd>←</kbd>和<kbd>→</kbd>；长按<kbd>Shift</kbd>+<kbd>i</kbd>、<kbd>k</kbd>、<kbd>j</kbd>和<kbd>l</kbd>键分别输入<kbd>Ctrl</kbd>+<kbd>Home</kbd>（滚动到页首）
、<kbd>Ctrl</kbd>+<kbd>End</kbd>（滚动到页尾）、<kbd>Home</kbd>和<kbd>End</kbd>（2026/4/12）
...
* 🔧️将部分和自定义设置有关的全局变量从`FinalD.ahk`移动到`Shortcut.ahk`（2026/4/12）
