...
| 2025/6/1   | v5.59.150 | 通过drift函数来进行标点漂移，方便自定制；增加[中文标点提示](#中文标点提示)功能；在有自动配对标点功能的应用程序中禁用此程序；ℹ️由于此项目不再是单文件项目，安装方法有变动，详情见『[安装步骤](#安装步骤)』。 |
...
## 后续操作
* 如果你在使用某些有自动配对标点功能的编程软件时遇到问题，则需要将其添加到“AutoPair”程序组，具体做法参考[安装步骤](#安装步骤)中的4.ⅴ步。
