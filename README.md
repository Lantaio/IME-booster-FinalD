...
## 摘要
[FinalD.ahk](Win/FinalD.ahk)最新版本：v5.57.141（*2025/4/6*）
...
| 2025/4/6   | v5.57.141 | 通过drift函数来进行标点漂移，方便自定制；在『[安装步骤](#安装步骤)』中增加第6点。 |
|            |           |                                                              |
...
6. 须要关闭Office Word的“使用智能段落选择”功能。具体步骤是打开Word，依次点击「文件」菜单→左下角「选项」→在打开的『Word选项』窗口中选择左边中间的「高级」→右边「编辑选项」中取消勾选“使用智能段落选择”。
