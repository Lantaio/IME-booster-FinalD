...
📣️**公告**：5.x版现已推出，增加“兼容模式”，具体见[兼容模式](#兼容模式)或[更新日志](joy/ChangeLog.md)。⚠修改此程序的源代码后须要以UTF-8编码方式保存文件。

[FinalD_un.ahk](Win/FinalD_un.ahk) 通用版：v5.45.101 (*2024/12/16*) \
[FinalD_rm.ahk](Win/FinalD_rm.ahk) Rime定制版：v5.45.99 (*2024/12/16*) \
...
另外，当光标在数字0~9后面时，按左<kbd>Shift</kbd>键可以变换为相应的大、小写希腊数字和空心数字序号，按右<kbd>Shift</kbd>键则会变换为相应的下、上标数字和实心数字序号，下图以数字2为例：
