...
## 摘要
最新版本：[v5.59.150](archive/refs/tags/v5.59.150.zip)（*2025/6/1*）
...
| 2025/6/1   | v5.59.150 | 通过drift函数来进行标点漂移，方便自定制；增加[中文标点提示](#中文标点提示)功能；在有自动配对标点功能的应用程序中禁用此程序；ℹ️由于此项目不再是单文件项目，安装方法有变动，详情见『[安装步骤](#安装步骤%EF%B8%8F)』。 |
