...
| 2025/6/8   | v5.59.151 | 通过drift函数来进行标点漂移，方便自定制；增加[中文标点提示](#中文标点提示)功能；在有自动配对标点功能的应用程序中禁用此程序；ℹ️由于此项目不再是单文件项目，安装方法有变动，详情见『[安装步骤](#安装步骤%EF%B8%8F)』。 |
...
2. **下载程序文件**：下载最新版的[Zip压缩包](https://github.com/Lantaio/IME-booster-FinalD/tags)，只需解压其中的Win目录，主程序是Win目录中的FinalD.ahk。
...
## 后续操作
* 如果你在使用某些有自动配对标点功能的编程软件时遇到问题，则需要将其添加到“AutoPair”程序组，具体做法类似于[安装步骤](#安装步骤%EF%B8%8F)中的4.ⅴ步。
...
2. 打开系统的『文件资源管理器』，找到此插件程序的所在目录并将其删除。
