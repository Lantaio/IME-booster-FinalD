...
在此插件的源代码开头的`GroupAdd "CNApp"`部分，有些预设项，可按需删除或临时注释掉不想以中文标点为主的预设项，也可以添加你希望以中文标点为主的应用程序。采用正则表达式写法，你还可以参考[帮助文档](https://wyagd001.github.io/v2/docs/lib/GroupAdd.htm)。
