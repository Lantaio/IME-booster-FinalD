...
[FinalD_un.ahk](Win/FinalD_un.ahk) 通用版：v5.48.108 (*2024/12/24*) \
[FinalD_rm.ahk](Win/FinalD_rm.ahk) Rime定制版：v5.48.106 (*2024/12/24*) \
...
这个输入法插件（以下简称此插件）的初衷就是要走完这最后的一公里，希望通过上下文来智能输入中/英标点符号，并且可以用<kbd>Shift</kbd>键快速变换，达到无需切换中/英输入模式的目的，<mark style="background-color: GoldenRod;">**把所有中文输入法带进真正意义上的中英混输新纪元**</mark>。
