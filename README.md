...
📣️**公告**：v5.56版现已推出，大部分标点通过drift函数来实现循环变换，使代码更简洁直观，并且更方便自定制。关键更新见[功能摘要](#功能摘要)，详细更新内容见[更新日志](joy/ChangeLog.md)。
