...
[FinalD_un.ahk](Win/FinalD_un.ahk) 通用版：v2.36.74 (*2024/8/17*) \
[FinalD_rm.ahk](Win/FinalD_rm.ahk) Rime定制版：v2.37.73 (*2024/8/17*) \
...
另外，当光标在数字0~9后面时，按左<kbd>Shift</kbd>键可以切换为相应的大小写希腊数字和空心数字序号，按右<kbd>Shift</kbd>键则会切换为相应的上、下标数字和实心数字序号，下图以数字2为例：
...
* ⚠在输入密码时会出问题，导致输入的密码不正确！暂时无法解决，只能在输入密码之前通过快捷键左<kbd>Ctrl</kbd>+左<kbd>Win</kbd>暂时停用此插件。
...
*提示：此收费不包括任何软件功能及其稳定性方面的承诺或保证，现阶段也无法提供技术支持服务。*
