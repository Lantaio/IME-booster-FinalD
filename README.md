...
呃...事情不是你想象的那么复杂，你听我狡辩。这张图看似复杂，但看完下面的说明，你就会觉得它很简单。
...
⚠因为英文字母和数字的漂移功能不常用，为免在输入时误按<kbd>Shift</kbd>键导致错误变换光标前的内容，此功能**默认关闭**，可通过快捷键组合左<kbd>Shift</kbd>+左<kbd>Win</kbd>开/关此功能。
